...
function AdminDashboard() {
  ...
  // Add default data
  const stats = [
    { title: 'Total Appointments', value: '24', increase: '+12%', color: '#10B981' },
    { title: 'New Clients', value: '8', increase: '+5%', color: '#3B82F6' },
    { title: 'Total Revenue', value: '$2.4k', increase: '+8%', color: '#8B5CF6' },
    { title: 'Pending Reviews', value: '6', increase: '+2%', color: '#F59E0B' }
  ];

  const appointments = [
    { id: 1, name: 'Sarah Davis', service: 'Consultation', date: 'Tomorrow', time: '2:30 PM' },
    { id: 2, name: 'Mike Johnson', service: 'Follow-up', date: 'Sep 25', time: '10:00 AM' }
  ];

  const testimonials = [
    { id: 1, name: 'John Smith', company: 'ABC Corp', rating: 5, content: 'Excellent service!' },
    { id: 2, name: 'Emma Wilson', company: 'XYZ Inc', rating: 4, content: 'Very professional' }
  ];

  return (
    <div className="p-6 mt-16"> {/* Added mt-16 to account for header height */}
