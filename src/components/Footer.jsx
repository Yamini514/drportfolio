    ...
    >
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mb-12 place-items-center">
          <div className="w-full md:max-w-[300px] text-center" title={accountHolderName}>
          ...
          <div className="flex flex-col items-center" title={accountHolderName}>
        ...
        <div className="border-t" style={{ borderColor: currentTheme.border }}>
          <div className="pt-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm mb-4 md:mb-0 text-center" style={{ color: currentTheme.text.secondary }} title={accountHolderName}>
